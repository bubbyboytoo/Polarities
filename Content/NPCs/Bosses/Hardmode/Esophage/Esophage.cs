...
namespace Polarities.Content.NPCs.Bosses.Hardmode.Esophage
{
    [AutoloadBossHead]
    public class Esophage : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/Esophage");
        ...
        public static void SpawnOn(Player player)
        {
            ...
            int boss = NPC.NewNPC(NPC.GetBossSpawnSource(player.whoAmI), (int)(player.Center.X + (500 * r + 1000) * (float)Math.Cos(theta)), (int)(player.Center.Y - (500 * r + 1000) * (float)Math.Sin(theta)), NPCType<Esophage>());
    ...
    {
        public override string Texture => "Polarities/Content/NPCs/Enemies/WorldEvilInvasion/CrimagoSlash";
