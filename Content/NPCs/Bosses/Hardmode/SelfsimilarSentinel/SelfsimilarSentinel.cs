...
namespace Polarities.Content.NPCs.Bosses.Hardmode.SelfsimilarSentinel
{
	...
	public class SelfsimilarSentinel : ModNPC
	{
        ...
        public override void AI()
		{
				...
				switch(NPC.ai[0])
                {
					...
					case -2:
						...
						if (NPC.ai[1] == 0)
                        {
                            ...
                            Main.LocalPlayer.GetModPlayer<PolaritiesPlayer>().screenshakeMagnitude = 12;
						...
						if (DeathAnimationSegmentsLeft(NPC.ai[1]) != DeathAnimationSegmentsLeft(NPC.ai[1] + 1))
                        {
                            ...
                            Main.LocalPlayer.GetModPlayer<PolaritiesPlayer>().screenshakeMagnitude = 12;
                            Main.LocalPlayer.GetModPlayer<PolaritiesPlayer>().screenshakeTimer = 12;
                        }
			...
			else
			{
				...
				if (amountThroughFirstPhase >= 1 && NPC.ai[0] < 5)
				{
					...
					Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/SentinelP2");
				}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			Texture2D spikeTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/SelfsimilarSentinelSpike").Value;
			Rectangle spikeTextureFrame = spikeTexture.Frame();
			Vector2 spikeTextureCenter = new Vector2(21, 84);

			Texture2D arcChainTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/SelfsimilarSentinelChain").Value;
			Vector2 arcChainTextureCenter = new Vector2(arcChainTextureFrame.Width * 0.5f - 1, arcChainTextureFrame.Height * 0.5f);

			Texture2D arcChainGlowTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/SelfsimilarSentinelChainGlow").Value;
			Rectangle arcChainGlowFrame = arcChainGlowTexture.Frame();
			Vector2 arcChainGlowCenter = arcChainGlowFrame.Center();

			Texture2D glowAuraTexture = ModContent.Request<Texture2D>("Polarities/Assets/Glow256").Value;
	...
	public class SentinelArenaDraw : IDrawType
    {
        ...
        public void Draw()
		{
			if (sentinelArena == null) sentinelArena = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/SentinelArena").Value; //ArenaSpotlight
	...
	{
		public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/SelfsimilarSentinel";
	...
	public class HyperbolicBolt : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Texture2D glowTexture = ModContent.Request<Texture2D>($"Polarities/Assets/Glow58").Value;
			...
			{
				Texture2D telegraphTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/HyperbolicBoltTelegraph").Value;
	...
	public class HyperbolicRay : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Texture2D glowTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/HyperbolicRayGlow").Value;
			Rectangle glowFrame = glowTexture.Frame();
			Vector2 glowCenter = new Vector2(0, glowFrame.Height * 0.5f);

			Texture2D capTexture = ModContent.Request<Texture2D>("Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/HyperbolicRayCap").Value;
	...
	{
        public override string Texture => "Polarities/Content/NPCs/Bosses/Hardmode/SelfsimilarSentinel/HyperbolicAperiogon";
