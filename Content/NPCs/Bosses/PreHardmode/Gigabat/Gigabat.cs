...
using Polarities.Content.Items.Tools.Misc;
...
using Polarities.Content.Items.Weapons.Melee.Flails.PreHardmode;
...
namespace Polarities.Content.NPCs.Bosses.PreHardmode.Gigabat
{
    [AutoloadBossHead]
    ...
    public class Gigabat : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Music = MusicLoader.GetMusicSlot(Mod, "Assets/Sounds/Music/Gigabat");
        }
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.BossBag(ItemType<GigabatBag>()));
            npcLoot.Add(ItemDropRule.MasterModeCommonDrop(ItemType<GigabatRelic>()));
            npcLoot.Add(ModUtils.MasterModeDropOnAllPlayersOrFlawless(ItemType<GigabatPetItem>(), 4));

            //normal mode loot
            LeadingConditionRule notExpertRule = new LeadingConditionRule(new Conditions.NotExpert());
            notExpertRule.OnSuccess(ItemDropRule.Common(ItemType<GigabatMask>(), 7));
            notExpertRule.OnSuccess(new OneFromOptionsWithCountsNotScaledWithLuckDropRule(1, 1,
                (ItemType<BatSigil>(), 1, 1),
                (ItemType<EchoStaff>(), 1, 1),
                (ItemType<ChainSaw>(), 1, 1),
                (ItemType<BatArrow>(), 500, 999)));
            npcLoot.Add(notExpertRule);

            npcLoot.Add(ItemDropRule.ByCondition(new FlawlessDropCondition(), ItemType<Batastrophe>()));
        }
